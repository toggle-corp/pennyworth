"""
Django settings for pennyworth project.
"""
...
SECRET_KEY = 'reo*k%8kt)79xmuwjl(%p!e7ixg9-g(ry6fm&fqk$s_7agwb=)'
...
WSGI_APPLICATION = 'pennyworth.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER':
        'pennyworth.exception_handler.custom_exception_handler',
